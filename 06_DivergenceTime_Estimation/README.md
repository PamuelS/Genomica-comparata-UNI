...
Per riuscire a calibrare un albero filogenetico sono necessarie delle informazioni a priori che consentano di stimare temporalmente la divergenza tra i vari taxa all'interno dell'albero delle specie. Questa informazione è stata ottenuta tramite [Timetree.org](https://timetree.org). Con l'acquisizione di questi dati è stato creato un file di "calibrazione" con le coordinate temporali dei nodi e delle specie legate a quel nodo.
