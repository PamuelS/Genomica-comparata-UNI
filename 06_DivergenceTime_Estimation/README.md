...
Infine è stata eseguita l'analisi per la ricerca dell'albero tramite il metodo di Maximum Likelihood, piuttosto che eseguire una analisi con il metodo dell'inferenza Bayesiana, dato che l'ottenimento dell'albero ultramtrico è necessario solo per l'osservazione dell'evoluzione delle famiglie geniche 
