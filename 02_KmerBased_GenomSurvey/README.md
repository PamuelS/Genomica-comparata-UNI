...
Procedimento iniziale che consente di acquisire le informazioni sullo stato di qualità delle short-reads, ottenute precedentemente mediante il sequenziamento dell'organismo *Anopheles stephensis*.                        Per ottenere queste informazioni, vengono esegueite tre operazioni distinte riportate al di sotto.
...
```bash
#|kat|
kat hist -t 6 -m 27 -o Anoste_kmer27 SRR11672503_1_paired_fastqc SRR11672503_2_paired_fastqc
```
