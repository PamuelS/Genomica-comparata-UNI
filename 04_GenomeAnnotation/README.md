# Genome Annotation 
L'annotazione rappresenta la fase che segue l'assemblaggio di un genoma, ed è il momento in cui vengono identificate e descritte tutte le funzioni della sequenza genomica ottenuta, come ad esempio: sequenze codificanti, pseudogeni, trasposoni, ncRNA, tRNA, ecc. Quello che viene eseguito nell'effettivo è l'associazione di una funzione bilogica a quello che per il momento rappresenta solamente una sequenza anonima di nucleotidi, associando una posizione alla funzione descritta.
